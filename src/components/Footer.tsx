      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          <div className="col-span-2 md:col-span-1">
            <div className="flex flex-col space-y-4">
              <a href="#" className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-brand-600 to-brand-800">
                BrandMatchBot
              </a>
              <p className="text-sm text-gray-500 mt-2">
                AI-powered matchmaking for brands and creators. Simplifying partnerships through technology.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><FooterLink href="#waitlist">Waitlist</FooterLink></li>
        ...
        <div className="border-t border-gray-100 mt-10 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} BrandMatchBot. All rights reserved.
          </p>
          
          <div className="flex space-x-6 mt-4 md:mt-0">
            <FooterLink href="#" className="text-gray-400 hover:text-gray-500">
